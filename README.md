...
```javascript
import int2slice from 'https://cdn.jsdelivr.net/gh/stdlib-js/slice-base-int2slice@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/slice-base-int2slice/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/slice-base-int2slice/actions/workflows/test.yml?query=branch:v0.1.0
